...
# Seed
author = Author.objects.create(first_name="Fake", last_name="Author")

Article.objects.create(author=author, title="Fake Article", content="Fake Content").regions.set(
    [
        Region.objects.create(code="AL", name="Albania"),
        Region.objects.create(code="UK", name="United Kingdom"),
    ]
)
Article.objects.create(author=author, title="Fake Article", content="Fake Content")
Article.objects.create(author=author, title="Fake Article", content="Fake Content")
Article.objects.create(author=author,title="Fake Article", content="Fake Content")
Article.objects.create(author=author, title="Fake Article", content="Fake Content").regions.set(
    [
